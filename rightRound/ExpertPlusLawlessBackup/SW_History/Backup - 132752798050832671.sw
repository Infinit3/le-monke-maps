...
20:ModelToWall
	path:circleblend.dae
	duration:18
	interactable:false
	animateposition:[0,0,0,0],[0,0,20,0.5]
	color:[5,0,0,20]
	animateDissolve:[0,0],[1,0.5],[1,1]
...
20:note
	...
	animateDissolve:[0.3,0]
	
21:AnimateTrack
	track:spin
	duration:6
	animateRotation:[0,0,0,0],[30,0,0,0.5],[0,0,0,1]
