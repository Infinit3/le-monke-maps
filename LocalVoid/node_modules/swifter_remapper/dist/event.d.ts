...
export declare namespace EventInternals {
    ...
    class LightEvent extends EventInternals.BaseEvent {
         ...
         * @returns
         */
        on(color: number[] | boolean, lightID?: number | number[]): this;
        /**
         ...
         * @returns
         */
        flash(color: number[] | boolean, lightID?: number | number[]): this;
        /**
         ...
         * @returns
         */
        fade(color: number[] | boolean, lightID?: number | number[]): this;
        /**
         ...
         * @returns
         */
        in(color: number[] | boolean, lightID?: number | number[]): this;
        /**
         ...
         * @returns
         */
        gradient(startColor: number[], endColor: number[], duration: number, easing?: string): this;
        /**
