import { Vec4, ColorType } from "./general";
export declare class Color {
     ...
     */
    toFormat(format: string, alert?: boolean): void;
    /**
 ...
 */
export declare function lerpColor(start: Color, end: Color, fraction: number, easing?: any, format?: string): Color;
