 ...
 * @author StormPacer
 */
function Fire(startingBeat, duration, fireWallDuration, size, x, y, z) {
    for (let i = 0; i < (duration * 6); i++) {
        ...
        wall.customData = {
            ...
            _animation: {
                ...
                _localRotation: [[(0, random_1.Random)(0, 180), (0, random_1.Random)(0, 180), (0, random_1.Random)(0, 180), 0], [(0, random_1.Random)(0, 180), (0, random_1.Random)(0, 180), (0, random_1.Random)(0, 180), 1]],
                _definitePosition: [[x, y, z, 0, "easeOutCubic"], [(x + (0, random_1.Random)(-2, 2)), (y + (0, random_1.Random)(3, 5)), z, 1]]
            }
        };
        wall.push();
    }
